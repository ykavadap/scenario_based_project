...
if(mysqli_query($conn,$check)){
    ...
    $query = "select * from users where approval='0'"; 
     ...
     echo '<tr><th>Name</th><th>Email</th><th>View</th><th>Company</th><th>Reason</th><th>Accept</th><th>Reject</th></tr>' ;
     ...
     while($row = mysqli_fetch_assoc($result)){   //Creates a loop to loop through results
       ...
       // echo "<tr><td>" . $row['name'] . "</td><td>" . $row['email'] . "</td></tr>";  //$row['index'] the index here is a field name
        ...
        echo '<td><Input type = "CheckBox" Name ="accept" class="get_value" value= "Accept"></td>';
        echo '<td><Input type = "CheckBox" Name ="reject" class="get_value" value= "Reject"></td>';
